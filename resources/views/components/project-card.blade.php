...
{{-- Accepts: project (array) - Project data including id, name, description, status, tasks_count --}}
@props(['project'])
...
<div class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-200">
    ...
    <div class="flex items-center justify-between mb-4">
        <span class="text-sm text-gray-600">
            <span class="font-semibold text-gray-900">{{ $project['tasks_count'] }}</span> tasks
        </span>
    </div>
